...
const AntigravityInner: React.FC<AntigravityProps> = ({
  ...
  useFrame(state => {
    ...
    particles.forEach((particle, i) => {
      ...
      // Tighter visibility band (was 10, now 4) to keep effect small
      let scaleFactor = 1 - distFromRing / 4;
  ...
  return (
    <instancedMesh ref={meshRef} args={[undefined, undefined, count]}>
      ...
      {/* 
        Modified: Use transparency to make it subtle + "additive" blending for neon feel 
      */}
      <meshBasicMaterial 
        color={color} 
        transparent 
